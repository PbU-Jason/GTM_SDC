...
int parse_science_data(int input_file_pointer, char *input_file_path) {
    ...
    for (size_t i = 0; i < input_binary_buffer_size; i++) {
        ...
        if (science_1279_byte_buffer_counter == SCIENCE_ATTACHED_SYNCHRO_MARKER_SIZE+SCIENCE_TRANSFER_FRAME_SIZE+SCIENCE_REED_SOLOMON_CHECK_SYMBOLS_SIZE) {
            ...
            science_1279_byte_buffer+SCIENCE_ATTACHED_SYNCHRO_MARKER_SIZE+SCIENCE_PRIMARY_HEADER_SIZE, SCIENCE_TRANSFER_FRAME_DATA_FIELD_SIZE);
    ...
    for (size_t i = 0; i < strlen(science_icd_binary_buffer); i++) {
        ...
        if (science_1110_byte_buffer_counter == 1) {
    ...
    for (int i = 0; i < strlen(science_icd_binary_buffer); i++) {
