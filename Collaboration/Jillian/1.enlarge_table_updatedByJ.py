...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep  5 15:00:00 2023

Updated by jillianwu
version: 9/5/2023
"""
...
sensor_name_list = ['PP','PT','PB','PN','NN','NT','NB','NP']
#====================

### main code ###
# load data
df = pd.read_csv('./1.table/' + filename + '.csv')
df = df.reindex(columns=['theta','phi','require time (s)','PP','PT','PB','PN','NN','NT','NB','NP'])      # reindex it to the order of M1~4, S1~4
...
np.savetxt('./1.table/big_' + filename + '.csv', big_table, 
           delimiter=',', header='X, Y, Z, M1, M2, M3, M4, S1, S2 ,S3 ,S4')
#====================