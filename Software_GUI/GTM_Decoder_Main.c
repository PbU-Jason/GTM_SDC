...
int decoder(char *file_name, int input_in_space_flag, int input_decode_mode, int input_export_mode, int initail_file_pointer) {
    int new_file_pointer;

    check_endianness();

    in_space_flag = input_in_space_flag; // 1 = in space; 2 = on ground
